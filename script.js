document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateField(field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        if (VALIDATORS[rule] && !VALIDATORS[rule](value, param)) {
          return { valid: false, message: getErrorMessage(field, rule, param) };
        }
      }

      if (field.type === 'email' && field.value.trim() !== '') {
        if (!VALIDATORS.email(field.value)) {
          return { valid: false, message: getErrorMessage(field, 'email', null) };
        }
      }
  ...
  (function initRTL() {
    ...
    if (isRTL) {
      ...
      const rtlAnimatables = document.querySelectorAll('.fade-left, .fade-right');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ec35d271-c001-4535-b294-40ea966ea399',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ec35d271-c001-4535-b294-40ea966ea399';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ec35d271-c001-4535-b294-40ea966ea399';
